  ...
  return knex('menu_items').del()
    .then(function () {
      return Promise.all([
         ...
         knex('menu_items').insert({name: 'Pho', price: 7.00, image: '/images/3.jpg', description: 'Pho king good!', type: 'main', prep_time: 20, sold_out: false}),
         ...
         knex('menu_items').insert({name: 'Ramune', price: 4.00, image: '/images/5.jpg', description: 'I have never drank this before so i have no idea what to say about it', type: 'drink', prep_time: 5, sold_out: false}),
         knex('menu_items').insert({name: 'California Roll', price: 3.00, image: '/images/6.jpg', description: 'Not actual sushi', type: 'side', prep_time: 10, sold_out: false}),
         ...
         knex('menu_items').insert({name: 'Dim Sum', price: 2.50, image: '/images/8.jpg', description: 'You get one random dim sum dish (NO CHOOSING)', type: 'side', prep_time: 10, sold_out: false}),
      ]);
    });
};